        ...
        <div class="tab-content" id="v-pills-tabContent" style="width: 90%; height: 100%">
            <div class="tab-pane fade active show" id="v-pills-profile" role="tabpanel"
                ...
                <div style="height: 20%; width: 100%">
                    ...
                    <h4 style="text-align: center" class="text-primary">Add new</h4>
                </div>
                <form class="row" method="post">
                    <div class="col-md-4">
                        <label class="form-label">Name of rent person</label>
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                        <select class="form-select mb-3" aria-label=".form-select example" name="paymentType">
                            <option>Choose payment type</option>
                            <c:forEach var="list" items="${list}">
                                <option value="${list.getHouse_id()}">${list.getPayment_type()}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-6">
                        <button type="submit" class="btn btn-primary" href="/home?action=add">Add new</button>
                    </div>
                    <div class="col-6">
                        <button type="submit" class="btn btn-primary" href="/home?action=displayList">Cancel</button>
                    </div>
                </form>
