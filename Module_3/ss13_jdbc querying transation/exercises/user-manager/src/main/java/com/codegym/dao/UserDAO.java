...
public class UserDAO implements IUserDAO {
    ...
    private String jdbcPassword = "minh8893";
...
//    private static final String SELECT_ALL_USERS = "select * from users";
    private static final String SELECT_ALL_USERS = "call show_list_users();";
//    private static final String DELETE_USERS_SQL = "delete from users where id = ?;";
    private static final String DELETE_USERS_SQL = "call delete_user(?);";
//    private static final String UPDATE_USERS_SQL = "update users set name = ?,email= ?, country =? where id = ?;";
    private static final String UPDATE_USERS_SQL = "call edit_users(?,?,?,?);";
